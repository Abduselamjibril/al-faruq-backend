...
export class ContentController {
  ...
  @ApiResponse({ status: 200, description: 'Returns a list of all top-level content.', type: [Content] })
  @Get()
  findAllTopLevel() {
  ...
  @ApiOperation({ summary: 'Lock a content item and set its permanent and/or temporary rental price' })
  ...
  @ApiOperation({ summary: 'Unlock a content item, making it free to access' })
